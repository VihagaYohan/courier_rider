        ...
        if (locationProvider.isLoading == true) {
          ...
          return UIContainer(
            ...
            children: UIMap(
                ...
                name: widget.headerTitle == "Drop Location" || widget.headerTitle == "Order Tracking"
                    ? widget.orderDetail.receiverDetails.name
                    : widget.orderDetail.senderDetails.name,
                address: widget.headerTitle == "Drop Location" ||
                        widget.headerTitle == "Order Tracking"
                    ? widget.orderDetail.receiverDetails.address
                    : widget.orderDetail.senderDetails.address,
